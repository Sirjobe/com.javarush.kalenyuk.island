...
import island_v2_beta.entity.creature.animal.herbivore.*;
import island_v2_beta.entity.creature.animal.predactor.*;
import island_v2_beta.entity.creature.plant.Plant;
...
public class Settings {
    ...
    static {
        INITIAL_COUNT.put(Horse.class, 20);// 20
        INITIAL_COUNT.put(Deer.class,20);// 20
        INITIAL_COUNT.put(Rabbit.class,150);// 150
        INITIAL_COUNT.put(Mouse.class,500);// 500
